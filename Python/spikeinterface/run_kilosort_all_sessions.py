...
- A configuration file named 'run_kilosort_config.yaml' is present in the same directory as this script,
  ...
  towards the relevant Kilosort code.
...
print("Start running 'run_spike_sorting.py'")
...
#===========================================================================================================
# Main script: run Kilosort on all sessions in data directory for a given animal
#===========================================================================================================
...
for session_idx, session_ID in enumerate(sessionList):
    ...
    session_folder = os.path.join(base_folder_data, animal_ID, session_ID)
