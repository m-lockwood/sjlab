function fig = plot_trials_summary_v2(para, trial_data_session)
...
%% extract plot variables
    ...
    % port 1
    abortedTrialCue = double(trial_data_session.CorrectTrial);
    abortedTrialCue(~trial_data_session.AbortTrial) = nan;
