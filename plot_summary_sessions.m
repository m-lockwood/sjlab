...
ax2 = nexttile;
    ...
    choice_bias = session_summary.choice_port_1./(session_summary.choice_port_0+session_summary.choice_port_1);
    pl1 = plot(x, choice_bias, 'LineWidth',2, 'Color', para.colour_choice);
